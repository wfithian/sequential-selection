...
def compute_pvalues(y, X, active_set, sigma=1., maxstep=np.inf,
    ...
    for i in range(min([n, p, maxstep])):
        ...
        screened = set(active_set).issubset(FS_maxT.variables) or (i > 30) # can't be any power way out there... i figure
