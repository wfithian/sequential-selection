...
\newcommand{\RTcomment}[1]{{\color{red}{(RT: \bf \sc #1) }}}
...
to ensure this property. In Section \ref{sec:single step}  we  show how to construct valid selective $p$-values for a single step in the path and derive the max-t test
