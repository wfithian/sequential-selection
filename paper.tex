...
As we see below, a similar result holds for the LASSO ever-active path. In fact, it holds for a much larger class of $\ell_1$ regularized exponential family models including the graphical LASSO, group LASSO, and... \WFcomment{more? group LASSO not really $\ell_1$ penalty, but the result is true for group LASSO}
