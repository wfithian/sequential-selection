...
The {\tt Simple} rule stops at the first time that a p-value exceeds $\alpha$, while {\tt Forward} and {\tt Strong} refers ForwardStop and StrongStrop rules of Section \ref{sec:sequential}.}
\label{tab:stopping}
\end{table}
